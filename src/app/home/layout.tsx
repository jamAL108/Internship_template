...
export default function HomeLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className='MonaSans w-[100vw] min-h-[100vh] h-[100vh] flex base:flex-col bl:flex-row justify-center items-center base:bg-white bl:bg-[#fbfbfb] overflow-hidden'>
      <Navbar />
      <main className='bg-[#FFFFFF] base:w-full bl:w-auto bl:flex-1  bl:pt-[10px] base:h-full border-l-[1.8px] overflow-hidden'>
        {children}
      </main>
    </div>
  );
