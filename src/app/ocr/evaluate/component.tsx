...
const Component = () => {
    ...
    return (
        <div className="bg-[#FAFAFA] dark:bg-transparent min-h-[100vh] overflow-x-hidden flex items-center  flex-col md:w-[100%] base:w-[100%] text-pop">
            ...
            <div className='!z-[10] w-full h-[3.6rem] bg-white fixed bottom-0 left-0 flex justify-center items-center shadow-[0_-5px_2px_rgba(0,0,0,0.05)]'>
