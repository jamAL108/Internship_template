        ...
        <div className='base:w-[100%] lg:w-[calc(100%_-_380px)]  min-h-[100vh] flex  items-center flex-col '>
          ...
          <div className='w-[90%] h-auto flex flex-col gap-5'>
            ...
            <div className='w-full h-auto flex flex-col gap-1' >
              ...
              <p className='text-[0.94rem] w-[95%]'>Votum (&quot;<span className='font-[620]'>we</span>&quot;, &quot;<span className='font-[620]'>us</span>&quot;, or &quot;<span className='font-[620]'>our</span>&quot;) operates the <span className='text-[#5066E3] hover:underline cursor-poin'>https://thevotum.com</span> (&quot;<span className='font-[620]'>Service</span>&quot;) and is committed to protecting the privacy and security of your personal information. This policy outlines our practices concerning the collection, use, and sharing of your data and your rights in relation to this data under the General Data Protection Regulation (<span className='font-[620]'>GDPR</span>).  </p>
            </div>
            ...
            <div className='w-full flex flex-col mt-[40px] gap-[40px] mb-[100px]'>
              ...
              <div className='w-full flex flex-col gap-2 one'>
                ...
                <div className='flex flex-col text-[0.94rem] gap-[5px]'>
                  ...
                  <ul className='list-disc ml-[20px] flex flex-col gap-1'>
                    ...
                    <li>Technical data such as login information, IP address, browser type and version, time zone setting, etc.</li>
                    <li>Usage data including information on how you use our Service.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className='w-full flex flex-col gap-2 two'>
                ...
                <div className='flex flex-col text-[0.94rem] gap-[5px]'>
                  ...
                  <ul className='ml-[20px] list-disc flex flex-col gap-1'>
                    <li>Direct interactions when you provide it to us by filling in forms or by corresponding with us.</li>
                    <li>Automated technologies or interactions as you navigate through our Service.</li>
                    <li>Third parties or publicly available sources such as analytics providers, advertising networks, search information providers, etc.</li>
                  </ul>
                </div>
              </div>
              ...
              <div className='w-full flex flex-col gap-2 three'>
                ...
                <div className='flex flex-col text-[0.94rem] gap-[5px]'>
                  ...
                  <ul className='ml-[20px] list-disc flex flex-col gap-1'>
                    <li>Providing and managing your access to our Service.</li>
                    <li>Personalizing and tailoring your experience on our Service.</li>
                    <li>Supplying our services to you and communicating effectively as necessary to provide those services.</li>
